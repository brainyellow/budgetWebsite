...
<html>
	...
	<body>
		...
		<br/><br/><br/>
		<h1 align="center" style="font-family: helvetica;">Salary and Tax Calculator</h1>
		<div align = "center"> SELECT STATE <br>
			<select>
			...
			<br>
			<br>
			ENTER YOUR YEARLY GROSS SALARY <br>
			<input type="number" name="salary" onfocus="this.value=''" value="">
		</div>
	</body>
</html>